...
ALTER TABLE CONTRACT_MANAGEMENT DROP COLUMN DCODE_CLIENT;
ALTER TABLE CONTRACT_MANAGEMENT DROP COLUMN DU_DATE;
ALTER TABLE CONTRACT_MANAGEMENT DROP COLUMN CT_START;
ALTER TABLE CONTRACT_MANAGEMENT DROP COLUMN CT_END;
ALTER TABLE CONTRACT_MANAGEMENT DROP COLUMN DU_PRICE;
